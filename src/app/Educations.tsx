    ...
    return (
        ...
        <div className="container w-full flex flex-row flex-wrap mx-auto mb-20  justify-around items-center relative">
          <div>
            ...
            <div className="bg-custom-gradient-2 w-80 h-80 rounded-full flex items-center justify-center absolute top-[100px] right-[1103px] transform -translate-x-1/2 -translate-y-1/2 shadow-lg animate-spin-slow" style={{zIndex:-2}}>
            </div>
          </div>
          <div className="pt-12">
            <Timeline>
